  ...
  $scope.model = {
    ...
    clusters: [
      ...
      },
      {
        ...
        templates:[{step:1, x:"1%", y:"1vh", width: '34vw',src:"assets/clusters/clairon_dumesnil/templates/1a.html"}, {step:1, x:"69%", y:"20vh", width: '30vw', src:"assets/clusters/clairon_dumesnil/templates/1b.html"}, {step:2, x:"10%", y:"3vh", width:'45vw', src:"assets/clusters/clairon_dumesnil/templates/2a.html"}, {step:2, x:"40%", y:"57vh", width:'45vw', src:"assets/clusters/clairon_dumesnil/templates/2b.html"}],
